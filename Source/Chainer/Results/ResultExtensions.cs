...
/// <summary>
///     Provides extension methods for the <see cref="Result{T}" /> and <see cref="Result" /> types, enabling operations such as flattening, combining,
///     and handling success or failure conditions.
/// </summary>
