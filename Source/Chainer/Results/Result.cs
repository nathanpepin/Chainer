...
public readonly struct Result : IResult
{
    ...
    /// <returns>
    ///     A failure <see cref="Result" /> instance containing the error message and <see cref="System.Exception" /> derived from the provided
    ...
    ///     An asynchronous function that returns a <see cref="Task{TResult}" /> of <see cref="bool" />. It must return <c>true</c> for
    ...
    /// <returns>
    ///     A <see cref="Task{Result}" /> representing the asynchronous operation, which yields the original <see cref="Result" /> instance, allowing
    ///     for fluent chaining.
    /// </returns>
    ...
    /// </summary>
    /// <param name="binder">
    ///     A function that takes no arguments and returns a <see cref="Result" />. This function is executed only if the current result is
    ///     successful.
    /// </param>
    /// <returns>
    ///     The <see cref="Result" /> from the <paramref name="binder" /> function if the current result is successful; otherwise, the current failure
    ///     <see cref="Result" />.
    /// </returns>
    ...
    ///     If the current <see cref="Result" /> is a failure, it returns a <see cref="Task{Result}" /> containing the current failure <see cref="Result" />
    ///     without executing the function.
    ///     This is used for chaining asynchronous operations that return a <see cref="Result" />.
    /// </summary>
    /// <param name="binder">
    ///     An asynchronous function that takes no arguments and returns a <see cref="Task{Result}" />. This function is executed only if
    ///     the current result is successful.
    /// </param>
    /// <returns>
    ...
    ///     The function to execute if the <see cref="Result" /> is a failure. It receives the error message and the (optional)
    ...
    /// <param name="onFailure">
    ///     The asynchronous action (returning a <see cref="Task" />) to execute if the <see cref="Result" /> is a failure. It receives
    ///     the error message and the (optional) exception.
    /// </param>
    ...
    /// <summary>
    ///     Asynchronously executes one of the provided asynchronous functions based on whether the <see cref="Result" /> is a success or a failure, and
    ///     returns its result.
    /// </summary>
    /// <typeparam name="TResult">The type of the value to be returned by the match functions.</typeparam>
    ...
    /// <param name="onFailure">
    ///     The asynchronous function (returning a <see cref="Task{TResult}" /> of <typeparamref name="TResult" />) to execute if the
    ///     <see cref="Result" /> is a failure. It receives the error message and the (optional) exception.
    /// </param>
    /// <returns>
    ...
    /// <param name="onSuccess">The function to execute if the <see cref="Result" /> is successful. Returns a <typeparamref name="TResult" />.</param>
    /// <param name="onFailure">
    ///     The function to execute if the <see cref="Result" /> is a failure. It receives the error message and returns a
