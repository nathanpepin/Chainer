...
namespace Chainer.Building.Configuration.Binding;
...
public sealed class ChainConfigurationGroup
{
    ...
    ///   <item>Use a simple name that has been registered via <c>BindFromIConfiguration.AddSimpleTypeMaps&lt;T&gt;()</c></item>
    /// </list>
    ...
    public sealed class ChainConfigurationItem
    {
        ...
        ///   <item>Use a simple name that has been registered via <c>BindFromIConfiguration.AddSimpleTypeMaps&lt;T&gt;()</c></item>
        /// </list>
        /// The handler type must implement IChainHandler&lt;TContext&gt; for the context type specified in the parent configuration.
        /// </remarks>
